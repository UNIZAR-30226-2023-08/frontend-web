...
export function WaitingRoomPage({ roomSize=4 }) {
  ...
  return (
    <div className="grid grid-rows-[1fr_9fr] h-screen">
      <p className="row-start-1 flex justify-center items-end sm:my-[3%] font-semibold lg:text-4xl sm:text-3xl text-neutral-600 dark:text-neutral-200">Esperando jugadores</p>
