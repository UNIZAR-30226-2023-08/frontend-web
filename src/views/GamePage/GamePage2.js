import { Deck, Hand, Played2Players } from "../../components/Game/Game";
...
export function GamePage2P() {
  ...
  return (
    <div className="grid h-screen grid-rows-[1fr_3fr_1fr] grid-cols-[1fr_2fr_1fr]">
      <Played2Players playedCards={playedCards} playerNames={playerNames} />
